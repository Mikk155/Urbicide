/*
    ...
    useful for porting mods that uses titles.txt for showing messages.
    
DOWNLOAD:

scripts/maps/ReadTitles.as
scripts/maps/store/titles/newtitles.txt


INSTALL:


#include "mikk/ReadTitles"
...
then place your mod's titles.txt inside
scripts/maps/store/titles/titles.txt

NOTE: It is important that the .txt fiels goes into svencoop/ and not svencoop_addon/ or else the "newtitles" will be NOT writted.

Once you start the game the text file "newtitles" will be writted with all the entities in a ripent format
with a "name" meaning the message key. you must add targetname to them and spawn them in your maps
